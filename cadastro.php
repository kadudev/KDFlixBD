...
if(isset($_POST['submit'])){
  ...
  $csenha = ($_POST['password-in']);
  $senha_cript=md5($senha);

  include_once('config.php');

  $result = mysqli_query($conexao, "INSERT INTO login(nome, datanasc, email, senha) VALUES('$nome', '$datanasc', '$email', '$senha_cript')");
...
?>
  ...
  <body class="login-body">
    ...
    <main>
        ...
        <form action="cadastro.php" method="post" class="retang-cadastro" id="retang-cadastro">
          <a href="login.php"><h2 id="entrar">ENTRAR</h2></a>
          <div class="retang2-cadastro">
            <div class="inputs">
        <input type="text" name="nome" id="nome" placeholder="Nome & sobrenome" required>
        <input type="date" name="datanasc" id="data" placeholder="Nascimento" required>
          <input type="email" name="email" id="email" placeholder="E-mail" required>
          <input type="password" name="password" id="password" placeholder="Senha" required>
          <input type="password" name="password-in" id="password" placeholder="Confirme a senha" required>

              <input type="submit" value="Acessar" id="acesso" name="submit">
              
        </div>
          <div class="retang-google-cadastro"><div class="img-google"><img src="imgs/google.svg" alt="" draggable="false"></div>Entrar com o Google</div>
            </div>
        </form>
